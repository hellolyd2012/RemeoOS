...
@cd ..
@cd ..
@gcc -W -Wno-missing-field-initializer -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-unused-variable -Wextra -e BootLoaderMain -nostdinc -nostdlib -fno-builtin -Wl,--subsystem,10 -o Build\EFI\Boot\BootX64.efi Boot\Boot.c -I Includes
